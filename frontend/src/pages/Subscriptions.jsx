...
export default function Subscriptions() {
  ...
  return (
    <div className="subscriptions-page">
      ...
      {messageId && <div className="mc-modal-backdrop fixed inset-0 z-[60] bg-slate-950/50 p-3 md:p-8"><div className="mc-modal-panel mx-auto h-full max-w-5xl overflow-hidden border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900"><MessageView id={messageId} onClose={() => setMessageId(null)} /></div></div>}
    </div>
  );
}
